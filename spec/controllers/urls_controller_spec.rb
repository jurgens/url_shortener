...
describe UrlsController do
  ...
  let(:valid_attributes) { { "url_long" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved url as @url" do
        ...
        post :create, {:url => { "url_long" => "invalid value" }}, valid_session
        assigns(:url).should be_a_new(Url)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested url" do
        ...
        Url.any_instance.should_receive(:update_attributes).with({ "url_long" => "MyString" })
        put :update, {:id => url.to_param, :url => { "url_long" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the url as @url" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Url.any_instance.stub(:save).and_return(false)
        put :update, {:id => url.to_param, :url => { "url_long" => "invalid value" }}, valid_session
        assigns(:url).should eq(url)
      end
